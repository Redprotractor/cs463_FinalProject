...
public class PublicPrivateKey {
	...
	public static void main(String[] args) throws IOException {
		...
		BigInteger alphab = BigInteger.valueOf(alpha);
        ...
        BigInteger Ab = alphab.modPow(ab,pb);
        ...
        BigInteger Bb = alphab.modPow(bb,pb);
        
        System.out.println("Alice and Bob exchange public keys");
        System.out.println("Alice's public key is " + Ab);
        System.out.println("Bob's public key is " + Bb);
        
        System.out.println("\nGENERATE SHARED KEY");
        System.out.println("Alice computes shared key");
        BigInteger APb = Bb.modPow(ab, pb);
        System.out.println("Bob computes shared key");
        BigInteger BPb = Ab.modPow(bb,pb);
        System.out.println("\nCheck that Alice and Bob's shared keys are the same");
		System.out.println("Alices computed shared key is " + APb);
		System.out.println("Bob's computed shared key is " + BPb);
        System.out.println("Keys are equal: " + APb.equals(BPb));
		input.close();
	}
